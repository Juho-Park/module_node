...
export const Subjects = [
    { id: 1, label: '국어', value: 'korean' },
    { id: 2, label: '수학', value: 'math' },
    { id: 3, label: '영어', value: 'english' },
    { id: 4, label: '한국사', value: 'korean_history' },
    { id: 5, label: '과학 탐구', value: 'science' },
    { id: 6, label: '사회 탐구', value: 'social_studies' },
]
